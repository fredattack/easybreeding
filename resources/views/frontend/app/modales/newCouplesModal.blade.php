        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                   {!! Form::open(array('route' => 'frontend.app.storeBird',
                                        'method' => 'POST',
                                        'id'=>'createCouple',
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select class="form-control custom-select" name="femalesId" id="females" required data-parsley-errors-container="#femaleError">
